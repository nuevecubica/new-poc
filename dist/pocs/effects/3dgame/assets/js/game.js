...
var particlesPool = [];
var particlesInUse = [];
var leWorld = document.getElementById('game_three');
...
function createScene() {
    ...
    WIDTH =  leWorld.offsetWidth; //window.innerWidth;

    console.log(leWorld.offsetWidth+'  '+WIDTH);
...
function handleWindowResize() {
    HEIGHT = leWorld.offsetHeight; //window.innerHeight;
    WIDTH = leWorld.offsetWidth; //window.innerWidth;
    renderer.setSize(WIDTH, HEIGHT);
